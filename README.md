...
#### [package](5d7a) `40ants-routes/breadcrumbs`
...
###### [class](f740) `40ants-routes/breadcrumbs:breadcrumb` ()
...
###### [reader](2914) `40ants-routes/breadcrumbs:breadcrumb-path` (breadcrumb) (:path)
...
###### [reader](d934) `40ants-routes/breadcrumbs:breadcrumb-route` (breadcrumb) (:route)
...
###### [reader](d2b2) `40ants-routes/breadcrumbs:breadcrumb-title` (breadcrumb) (:title)
...
##### [function](f5c8) `40ants-routes/breadcrumbs:get-breadcrumbs`
...
##### [function](0eef) `40ants-routes/breadcrumbs:make-breadcrumb` title
...
#### [package](ffdc) `40ants-routes/defroutes`
...
##### [function](4d56) `40ants-routes/defroutes:include` routes &key (path "/")
...
##### [macro](a8ca) `40ants-routes/defroutes:defroutes` (var-name &key namespace (routes-class 'routes)) &body route-definitions
...
##### [macro](37ef) `40ants-routes/defroutes:extend-routes` (var-name) &body route-definitions
...
##### [macro](fabb) `40ants-routes/defroutes:get` (path &key name title (route-class 'route)) &body handler-body

<a id="x-2840ANTS-ROUTES-2FDEFROUTES-3APOST-20-2840ANTS-DOC-2FLOCATIVES-3AMACRO-29-29"></a>

##### [macro](7593) `40ants-routes/defroutes:post` (path &key name title (route-class 'route)) &body handler-body

<a id="x-2840ANTS-ROUTES-2FDEFROUTES-3APUT-20-2840ANTS-DOC-2FLOCATIVES-3AMACRO-29-29"></a>

##### [macro](ce07) `40ants-routes/defroutes:put` (path &key name title (route-class 'route)) &body handler-body
...
#### [package](3ff9) `40ants-routes/errors`
...
###### [condition](d92d) `40ants-routes/errors:argument-missing-error` (error)
...
###### [reader](d92d) `40ants-routes/errors:argument-missing-error-parameter` (argument-missing-error) (:missing-parameter)
...
###### [reader](d92d) `40ants-routes/errors:argument-missing-error-route-name` (argument-missing-error) (:route-name)
...
###### [condition](6b85) `40ants-routes/errors:namespace-duplication-error` (error)
...
###### [reader](6b85) `40ants-routes/errors:existing-namespace` (namespace-duplication-error) (:namespace)
...
###### [reader](6b85) `40ants-routes/errors:existing-route` (namespace-duplication-error) (:existing-route)
...
###### [reader](6b85) `40ants-routes/errors:new-route` (namespace-duplication-error) (:new-route)
...
###### [condition](cbb4) `40ants-routes/errors:no-common-elements-error` (error)
...
###### [reader](cbb4) `40ants-routes/errors:full-namespace` (no-common-elements-error) (:full-namespace)
...
###### [reader](cbb4) `40ants-routes/errors:relative-namespace` (no-common-elements-error) (:relative-namespace)
...
###### [condition](819a) `40ants-routes/errors:no-route-for-url-error` (error)
...
###### [reader](819a) `40ants-routes/errors:error-routes-path` (no-route-for-url-error) (:routes-path)
...
###### [reader](819a) `40ants-routes/errors:error-url` (no-route-for-url-error) (:url)
...
###### [condition](5773) `40ants-routes/errors:path-duplication-error` (error)
...
###### [reader](5773) `40ants-routes/errors:existing-path` (path-duplication-error) (:path)
...
###### [reader](5773) `40ants-routes/errors:existing-route` (path-duplication-error) (:existing-route)
...
###### [reader](5773) `40ants-routes/errors:new-route` (path-duplication-error) (:new-route)
...
###### [condition](d961) `40ants-routes/errors:url-resolution-error` (error)
...
###### [reader](d961) `40ants-routes/errors:namespace` (url-resolution-error) (:namespace)
...
###### [reader](d961) `40ants-routes/errors:route-name` (url-resolution-error) (:route-name)
...
#### [package](1d11) `40ants-routes/find-route`
...
##### [function](098e) `40ants-routes/find-route:find-route` name &key namespace on-match
...
#### [package](cacf) `40ants-routes/generics`
...
##### [generic-function](72c8) `40ants-routes/generics:add-route` routes route-or-routes-to-add &key override
...
##### [generic-function](bdb8) `40ants-routes/generics:format-url` obj stream args
...
##### [generic-function](fcd0) `40ants-routes/generics:get-route-breadcrumbs` node
...
##### [generic-function](c914) `40ants-routes/generics:has-namespace-p` routes
...
##### [generic-function](2488) `40ants-routes/generics:match-url` obj url &key on-match
...
##### [generic-function](1e81) `40ants-routes/generics:node-namespace` routes
...
##### [generic-function](99df) `40ants-routes/generics:partial-match-url` obj url
...
##### [generic-function](8d69) `40ants-routes/generics:url-path` obj
...
#### [package](336e) `40ants-routes/handler`
...
##### [function](9273) `40ants-routes/handler:call-handler`
...
#### [package](b4e6) `40ants-routes/included-routes`
...
###### [class](7511) `40ants-routes/included-routes:included-routes` ()
...
###### [reader](f7d4) `40ants-routes/included-routes:original-routes` (included-routes) (:original-collection)
...
###### [reader](f8a5) `40ants-routes/generics:url-path` (included-routes) (:path)
...
##### [function](2e08) `40ants-routes/included-routes:included-routes-p` obj
...
#### [package](eb65) `40ants-routes/matched-route`
...
###### [class](18bb) `40ants-routes/matched-route:matched-route` ()
...
###### [reader](aa42) `40ants-routes/matched-route:matched-route-parameters` (matched-route) (:parameters = nil)
...
###### [reader](594a) `40ants-routes/matched-route:original-route` (matched-route) (:original-route)
...
##### [function](c31d) `40ants-routes/matched-route:matched-route-p` obj
...
#### [package](b583) `40ants-routes/route`
...
###### [class](ab3c) `40ants-routes/route:route` ()
...
###### [reader](9361) `40ants-routes/route:route-handler` (route) (:handler)
...
###### [reader](1eae) `40ants-routes/route:route-method` (route) (:method = :get)
...
###### [reader](d704) `40ants-routes/route:route-name` (route) (:name)
...
###### [reader](3c91) `40ants-routes/route:route-title` (route) (:title = nil)
...
###### [reader](3cf9) `40ants-routes/generics:url-path` (route) (:pattern)
...
###### [class](aa6e) `40ants-routes/url-pattern:url-pattern` ()
...
###### [reader](8ead) `40ants-routes/url-pattern:url-pattern-params` (url-pattern) (:params)
...
###### [reader](ebbe) `40ants-routes/url-pattern:url-pattern-pattern` (url-pattern) (:pattern)
...
###### [reader](e167) `40ants-routes/url-pattern:url-pattern-regex` (url-pattern) (:regex)
...
##### [function](d80b) `40ants-routes/route:current-route`
...
##### [function](cbfc) `40ants-routes/route:current-route-p`
...
##### [function](eab8) `40ants-routes/route:routep` obj
...
#### [package](3d11) `40ants-routes/route-url`
...
##### [function](9e79) `40ants-routes/route-url:route-url` name &rest args &key namespace &allow-other-keys
...
#### [package](70ff) `40ants-routes/routes`
...
###### [class](ba78) `40ants-routes/routes:routes` ()
...
###### [reader](4064) `40ants-routes/routes:children-routes` (routes) (:children = nil)
...
###### [reader](7992) `40ants-routes/generics:node-namespace` (routes) (:namespace)
...
###### [accessor](4064) `40ants-routes/routes:children-routes` (routes) (:children = nil)
...
###### [accessor](7992) `40ants-routes/generics:node-namespace` (routes) (:namespace)
...
##### [function](e42a) `40ants-routes/routes:routesp` obj
...
##### [macro](978f) `40ants-routes/routes:routes` (namespace &key (routes-class 'routes)) &body route-definitions
...
#### [package](715f) `40ants-routes/url-pattern`
...
##### [function](927d) `40ants-routes/url-pattern:parse-url-pattern` pattern
...
##### [function](18ac) `40ants-routes/url-pattern:url-pattern-equal` left right

Compares two [`url-pattern`][a13f] objects

<a id="x-2840ANTS-ROUTES-2FURL-PATTERN-3AURL-PATTERN-P-20FUNCTION-29"></a>

##### [function](76a3) `40ants-routes/url-pattern:url-pattern-p` obj
...
#### [package](fd4c) `40ants-routes/with-url`
...
##### [macro](96fb) `40ants-routes/with-url:with-partially-matched-url` (root-routes url) &body body
...
##### [macro](39cc) `40ants-routes/with-url:with-url` (root-routes url) &body body
...
[5d7a]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/breadcrumbs.lisp#L1
[f740]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/breadcrumbs.lisp#L35
[2914]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/breadcrumbs.lisp#L36
[d2b2]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/breadcrumbs.lisp#L39
[d934]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/breadcrumbs.lisp#L42
[0eef]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/breadcrumbs.lisp#L84
[f5c8]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/breadcrumbs.lisp#L92
[ffdc]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/defroutes.lisp#L1
[fabb]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/defroutes.lisp#L146
[7593]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/defroutes.lisp#L150
[ce07]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/defroutes.lisp#L154
[4d56]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/defroutes.lisp#L166
[a8ca]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/defroutes.lisp#L36
[978f]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/defroutes.lisp#L74
[37ef]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/defroutes.lisp#L91
[3ff9]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/errors.lisp#L1
[cbb4]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/errors.lisp#L24
[6b85]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/errors.lisp#L35
[5773]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/errors.lisp#L49
[819a]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/errors.lisp#L63
[d961]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/errors.lisp#L74
[d92d]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/errors.lisp#L85
[1d11]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/find-route.lisp#L1
[098e]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/find-route.lisp#L103
[cacf]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/generics.lisp#L1
[2488]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/generics.lisp#L14
[99df]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/generics.lisp#L30
[bdb8]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/generics.lisp#L42
[8d69]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/generics.lisp#L48
[c914]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/generics.lisp#L52
[1e81]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/generics.lisp#L58
[72c8]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/generics.lisp#L62
[fcd0]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/generics.lisp#L68
[336e]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/handler.lisp#L1
[9273]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/handler.lisp#L15
[b4e6]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/included-routes.lisp#L1
[7511]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/included-routes.lisp#L20
[f7d4]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/included-routes.lisp#L21
[f8a5]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/included-routes.lisp#L25
[2e08]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/included-routes.lisp#L39
[eb65]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/matched-route.lisp#L1
[18bb]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/matched-route.lisp#L22
[594a]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/matched-route.lisp#L23
[aa42]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/matched-route.lisp#L27
[c31d]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/matched-route.lisp#L44
[3d11]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/route-url.lisp#L1
[9e79]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/route-url.lisp#L27
[b583]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/route.lisp#L1
[ab3c]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/route.lisp#L32
[d704]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/route.lisp#L33
[3cf9]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/route.lisp#L37
[9361]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/route.lisp#L41
[3c91]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/route.lisp#L45
[1eae]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/route.lisp#L50
[eab8]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/route.lisp#L68
[cbfc]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/route.lisp#L80
[d80b]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/route.lisp#L88
[70ff]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/routes.lisp#L1
[ba78]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/routes.lisp#L21
[4064]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/routes.lisp#L22
[7992]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/routes.lisp#L26
[e42a]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/routes.lisp#L39
[715f]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/url-pattern.lisp#L1
[76a3]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/url-pattern.lisp#L172
[18ac]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/url-pattern.lisp#L179
[aa6e]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/url-pattern.lisp#L24
[ebbe]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/url-pattern.lisp#L25
[e167]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/url-pattern.lisp#L28
[8ead]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/url-pattern.lisp#L31
[927d]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/url-pattern.lisp#L46
[fd4c]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/with-url.lisp#L1
[96fb]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/with-url.lisp#L112
[39cc]: https://github.com/40ants/routes/blob/5043429c556df5272f9f9d4ff4fceabf0e1d8159/src/with-url.lisp#L86
