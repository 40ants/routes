...
[![](https://img.shields.io/badge/SAFE-HAND%20MADE%20CODE-32CD32)][f8eb]
...
#### [package](f1ac) `40ants-routes/breadcrumbs`
...
###### [class](5873) `40ants-routes/breadcrumbs:breadcrumb` ()
...
###### [reader](3179) `40ants-routes/breadcrumbs:breadcrumb-path` (breadcrumb) (:path)
...
###### [reader](76bc) `40ants-routes/breadcrumbs:breadcrumb-route` (breadcrumb) (:route)
...
###### [reader](e525) `40ants-routes/breadcrumbs:breadcrumb-title` (breadcrumb) (:title)
...
##### [function](45dc) `40ants-routes/breadcrumbs:get-breadcrumbs`
...
##### [function](afbf) `40ants-routes/breadcrumbs:make-breadcrumb` title
...
#### [package](65f8) `40ants-routes/defroutes`
...
##### [function](4f30) `40ants-routes/defroutes:include` routes &key (path "/")
...
##### [macro](0a1a) `40ants-routes/defroutes:defroutes` (var-name &key namespace (routes-class 'routes)) &body route-definitions
...
<a id="x-2840ANTS-ROUTES-2FDEFROUTES-3AEXTEND-ROUTES-20-2840ANTS-DOC-2FLOCATIVES-3AMACRO-29-29"></a>

##### [macro](26f4) `40ants-routes/defroutes:extend-routes` (var-name) &body route-definitions

Extends a routes collection bound to a given `VAR-NAME` argument.

This macro works like [`defroutes`][3455] macro or [`routes`][77f9] macro, but instead of creating of
...
##### [macro](529a) `40ants-routes/defroutes:get` (path &key name title (route-class 'route)) &body handler-body

<a id="x-2840ANTS-ROUTES-2FDEFROUTES-3APOST-20-2840ANTS-DOC-2FLOCATIVES-3AMACRO-29-29"></a>

##### [macro](f240) `40ants-routes/defroutes:post` (path &key name title (route-class 'route)) &body handler-body

<a id="x-2840ANTS-ROUTES-2FDEFROUTES-3APUT-20-2840ANTS-DOC-2FLOCATIVES-3AMACRO-29-29"></a>

##### [macro](91ea) `40ants-routes/defroutes:put` (path &key name title (route-class 'route)) &body handler-body
...
#### [package](f0fa) `40ants-routes/errors`
...
###### [condition](9619) `40ants-routes/errors:argument-missing-error` (error)
...
###### [reader](9619) `40ants-routes/errors:argument-missing-error-parameter` (argument-missing-error) (:missing-parameter)
...
###### [reader](9619) `40ants-routes/errors:argument-missing-error-route-name` (argument-missing-error) (:route-name)
...
###### [condition](794f) `40ants-routes/errors:namespace-duplication-error` (error)
...
###### [reader](794f) `40ants-routes/errors:existing-namespace` (namespace-duplication-error) (:namespace)
...
###### [reader](794f) `40ants-routes/errors:existing-route` (namespace-duplication-error) (:existing-route)
...
###### [reader](794f) `40ants-routes/errors:new-route` (namespace-duplication-error) (:new-route)
...
###### [condition](4d05) `40ants-routes/errors:no-common-elements-error` (error)
...
###### [reader](4d05) `40ants-routes/errors:full-namespace` (no-common-elements-error) (:full-namespace)
...
###### [reader](4d05) `40ants-routes/errors:relative-namespace` (no-common-elements-error) (:relative-namespace)
...
###### [condition](f240a) `40ants-routes/errors:no-route-for-url-error` (error)
...
###### [reader](f240a) `40ants-routes/errors:error-routes-path` (no-route-for-url-error) (:routes-path)
...
###### [reader](f240a) `40ants-routes/errors:error-url` (no-route-for-url-error) (:url)
...
###### [condition](7bf8) `40ants-routes/errors:path-duplication-error` (error)
...
###### [reader](7bf8) `40ants-routes/errors:existing-path` (path-duplication-error) (:path)
...
###### [reader](7bf8) `40ants-routes/errors:existing-route` (path-duplication-error) (:existing-route)
...
###### [reader](7bf8) `40ants-routes/errors:new-route` (path-duplication-error) (:new-route)
...
###### [condition](1bd0) `40ants-routes/errors:url-resolution-error` (error)
...
###### [reader](1bd0) `40ants-routes/errors:namespace` (url-resolution-error) (:namespace)
...
###### [reader](1bd0) `40ants-routes/errors:route-name` (url-resolution-error) (:route-name)
...
#### [package](96b0) `40ants-routes/find-route`
...
##### [function](08ba) `40ants-routes/find-route:find-route` name &key namespace on-match
...
#### [package](37cf) `40ants-routes/generics`
...
##### [generic-function](d40e) `40ants-routes/generics:add-route` routes route-or-routes-to-add &key override
...
##### [generic-function](7128) `40ants-routes/generics:format-url` obj stream args
...
##### [generic-function](7ec2) `40ants-routes/generics:get-route-breadcrumbs` node
...
##### [generic-function](99ee) `40ants-routes/generics:has-namespace-p` routes
...
##### [generic-function](13a2) `40ants-routes/generics:match-url` obj url &key on-match
...
##### [generic-function](a889) `40ants-routes/generics:node-namespace` routes
...
##### [generic-function](b8db) `40ants-routes/generics:partial-match-url` obj url
...
##### [generic-function](b5a8) `40ants-routes/generics:url-path` obj
...
#### [package](3a24) `40ants-routes/handler`
...
##### [function](88b7) `40ants-routes/handler:call-handler`
...
#### [package](89ae) `40ants-routes/included-routes`
...
###### [class](0c96) `40ants-routes/included-routes:included-routes` ()
...
###### [reader](883a) `40ants-routes/included-routes:original-routes` (included-routes) (:original-collection)
...
###### [reader](85b1) `40ants-routes/generics:url-path` (included-routes) (:path)
...
##### [function](ed2a) `40ants-routes/included-routes:included-routes-p` obj
...
#### [package](1c87) `40ants-routes/matched-route`
...
###### [class](1764) `40ants-routes/matched-route:matched-route` ()
...
###### [reader](7f7a) `40ants-routes/matched-route:matched-route-parameters` (matched-route) (:parameters = nil)
...
###### [reader](e41c) `40ants-routes/matched-route:original-route` (matched-route) (:original-route)
...
##### [function](bc68) `40ants-routes/matched-route:matched-route-p` obj
...
#### [package](242a) `40ants-routes/route`
...
###### [class](4563) `40ants-routes/route:route` ()
...
###### [reader](2e6f) `40ants-routes/route:route-handler` (route) (:handler)
...
###### [reader](d905) `40ants-routes/route:route-method` (route) (:method = :get)
...
###### [reader](0d44) `40ants-routes/route:route-name` (route) (:name)
...
###### [reader](9b28) `40ants-routes/route:route-title` (route) (:title = nil)
...
###### [reader](2de1) `40ants-routes/generics:url-path` (route) (:pattern)
...
###### [class](04e5) `40ants-routes/url-pattern:url-pattern` ()
...
###### [reader](58b7) `40ants-routes/url-pattern:url-pattern-params` (url-pattern) (:params)
...
###### [reader](af98) `40ants-routes/url-pattern:url-pattern-pattern` (url-pattern) (:pattern)
...
###### [reader](3098) `40ants-routes/url-pattern:url-pattern-regex` (url-pattern) (:regex)
...
##### [function](b13e) `40ants-routes/route:current-route`
...
##### [function](ac3b) `40ants-routes/route:current-route-p`
...
##### [function](2650) `40ants-routes/route:routep` obj
...
#### [package](c61c) `40ants-routes/route-url`
...
##### [function](1698) `40ants-routes/route-url:route-url` name &rest args &key namespace &allow-other-keys
...
#### [package](ace9) `40ants-routes/routes`
...
###### [class](ef94) `40ants-routes/routes:routes` ()
...
###### [reader](36ad) `40ants-routes/routes:children-routes` (routes) (:children = nil)
...
###### [reader](2ccc) `40ants-routes/generics:node-namespace` (routes) (:namespace)
...
###### [accessor](36ad) `40ants-routes/routes:children-routes` (routes) (:children = nil)
...
###### [accessor](2ccc) `40ants-routes/generics:node-namespace` (routes) (:namespace)
...
##### [function](f94c) `40ants-routes/routes:routesp` obj
...
##### [macro](7caa) `40ants-routes/routes:routes` (namespace &key (routes-class 'routes)) &body route-definitions
...
#### [package](cd40) `40ants-routes/url-pattern`
...
##### [function](2bcf) `40ants-routes/url-pattern:parse-url-pattern` pattern
...
##### [function](834e) `40ants-routes/url-pattern:url-pattern-equal` left right

Compares two [`url-pattern`][a13f] objects

<a id="x-2840ANTS-ROUTES-2FURL-PATTERN-3AURL-PATTERN-P-20FUNCTION-29"></a>

##### [function](f408) `40ants-routes/url-pattern:url-pattern-p` obj
...
#### [package](0bd3) `40ants-routes/with-url`
...
##### [macro](846e) `40ants-routes/with-url:with-partially-matched-url` (root-routes url) &body body
...
##### [macro](167a) `40ants-routes/with-url:with-url` (root-routes url) &body body
...
[f8eb]: https://github.com/40ants/ai-badges
[6959]: https://github.com/40ants/routes
[f1ac]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/breadcrumbs.lisp#L1
[5873]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/breadcrumbs.lisp#L35
[3179]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/breadcrumbs.lisp#L36
[e525]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/breadcrumbs.lisp#L39
[76bc]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/breadcrumbs.lisp#L42
[afbf]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/breadcrumbs.lisp#L84
[45dc]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/breadcrumbs.lisp#L92
[65f8]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/defroutes.lisp#L1
[529a]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/defroutes.lisp#L146
[f240]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/defroutes.lisp#L150
[91ea]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/defroutes.lisp#L154
[4f30]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/defroutes.lisp#L166
[0a1a]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/defroutes.lisp#L36
[7caa]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/defroutes.lisp#L74
[26f4]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/defroutes.lisp#L91
[f0fa]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/errors.lisp#L1
[4d05]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/errors.lisp#L24
[794f]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/errors.lisp#L35
[7bf8]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/errors.lisp#L49
[f240a]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/errors.lisp#L63
[1bd0]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/errors.lisp#L74
[9619]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/errors.lisp#L85
[96b0]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/find-route.lisp#L1
[08ba]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/find-route.lisp#L103
[37cf]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/generics.lisp#L1
[13a2]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/generics.lisp#L14
[b8db]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/generics.lisp#L30
[7128]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/generics.lisp#L42
[b5a8]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/generics.lisp#L48
[99ee]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/generics.lisp#L52
[a889]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/generics.lisp#L58
[d40e]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/generics.lisp#L62
[7ec2]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/generics.lisp#L68
[3a24]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/handler.lisp#L1
[88b7]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/handler.lisp#L15
[89ae]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/included-routes.lisp#L1
[0c96]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/included-routes.lisp#L20
[883a]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/included-routes.lisp#L21
[85b1]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/included-routes.lisp#L25
[ed2a]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/included-routes.lisp#L39
[1c87]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/matched-route.lisp#L1
[1764]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/matched-route.lisp#L22
[e41c]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/matched-route.lisp#L23
[7f7a]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/matched-route.lisp#L27
[bc68]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/matched-route.lisp#L44
[c61c]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/route-url.lisp#L1
[1698]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/route-url.lisp#L27
[242a]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/route.lisp#L1
[4563]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/route.lisp#L32
[0d44]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/route.lisp#L33
[2de1]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/route.lisp#L37
[2e6f]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/route.lisp#L41
[9b28]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/route.lisp#L45
[d905]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/route.lisp#L50
[2650]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/route.lisp#L68
[ac3b]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/route.lisp#L80
[b13e]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/route.lisp#L88
[ace9]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/routes.lisp#L1
[ef94]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/routes.lisp#L21
[36ad]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/routes.lisp#L22
[2ccc]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/routes.lisp#L26
[f94c]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/routes.lisp#L39
[cd40]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/url-pattern.lisp#L1
[f408]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/url-pattern.lisp#L172
[834e]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/url-pattern.lisp#L179
[04e5]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/url-pattern.lisp#L24
[af98]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/url-pattern.lisp#L25
[3098]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/url-pattern.lisp#L28
[58b7]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/url-pattern.lisp#L31
[2bcf]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/url-pattern.lisp#L46
[0bd3]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/with-url.lisp#L1
[846e]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/with-url.lisp#L112
[167a]: https://github.com/40ants/routes/blob/a84678a98b98a004aca7bd1446138e97ce5c9e84/src/with-url.lisp#L86
