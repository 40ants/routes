...
#### [package](304f) `40ants-routes/breadcrumbs`
...
###### [class](9fe1) `40ants-routes/breadcrumbs:breadcrumb` ()
...
###### [reader](590f) `40ants-routes/breadcrumbs:breadcrumb-path` (breadcrumb) (:path)
...
###### [reader](f5f3) `40ants-routes/breadcrumbs:breadcrumb-route` (breadcrumb) (:route)
...
###### [reader](1533) `40ants-routes/breadcrumbs:breadcrumb-title` (breadcrumb) (:title)
...
##### [function](cfc8) `40ants-routes/breadcrumbs:get-breadcrumbs`
...
##### [function](4191) `40ants-routes/breadcrumbs:make-breadcrumb` title
...
#### [package](83ec) `40ants-routes/defroutes`
...
##### [function](563b) `40ants-routes/defroutes:include` routes &key (path "/")
...
##### [macro](361a) `40ants-routes/defroutes:defroutes` (var-name &key namespace (routes-class 'routes)) &body route-definitions
...
##### [macro](739e) `40ants-routes/defroutes:extend-routes` (var-name) &body route-definitions
...
##### [macro](18fd) `40ants-routes/defroutes:get` (path &key name title (route-class 'route)) &body handler-body

<a id="x-2840ANTS-ROUTES-2FDEFROUTES-3APOST-20-2840ANTS-DOC-2FLOCATIVES-3AMACRO-29-29"></a>

##### [macro](2874) `40ants-routes/defroutes:post` (path &key name title (route-class 'route)) &body handler-body

<a id="x-2840ANTS-ROUTES-2FDEFROUTES-3APUT-20-2840ANTS-DOC-2FLOCATIVES-3AMACRO-29-29"></a>

##### [macro](ea45) `40ants-routes/defroutes:put` (path &key name title (route-class 'route)) &body handler-body
...
#### [package](04a5) `40ants-routes/errors`
...
###### [condition](0de1) `40ants-routes/errors:argument-missing-error` (error)
...
###### [reader](0de1) `40ants-routes/errors:argument-missing-error-parameter` (argument-missing-error) (:missing-parameter)
...
###### [reader](0de1) `40ants-routes/errors:argument-missing-error-route-name` (argument-missing-error) (:route-name)
...
###### [condition](0818) `40ants-routes/errors:namespace-duplication-error` (error)
...
###### [reader](0818) `40ants-routes/errors:existing-namespace` (namespace-duplication-error) (:namespace)
...
###### [reader](0818) `40ants-routes/errors:existing-route` (namespace-duplication-error) (:existing-route)
...
###### [reader](0818) `40ants-routes/errors:new-route` (namespace-duplication-error) (:new-route)
...
###### [condition](78cf) `40ants-routes/errors:no-common-elements-error` (error)
...
###### [reader](78cf) `40ants-routes/errors:full-namespace` (no-common-elements-error) (:full-namespace)
...
###### [reader](78cf) `40ants-routes/errors:relative-namespace` (no-common-elements-error) (:relative-namespace)
...
###### [condition](5882) `40ants-routes/errors:no-route-for-url-error` (error)
...
###### [reader](5882) `40ants-routes/errors:error-routes-path` (no-route-for-url-error) (:routes-path)
...
###### [reader](5882) `40ants-routes/errors:error-url` (no-route-for-url-error) (:url)
...
###### [condition](bab8) `40ants-routes/errors:path-duplication-error` (error)
...
###### [reader](bab8) `40ants-routes/errors:existing-path` (path-duplication-error) (:path)
...
###### [reader](bab8) `40ants-routes/errors:existing-route` (path-duplication-error) (:existing-route)
...
###### [reader](bab8) `40ants-routes/errors:new-route` (path-duplication-error) (:new-route)
...
###### [condition](42da) `40ants-routes/errors:url-resolution-error` (error)
...
###### [reader](42da) `40ants-routes/errors:namespace` (url-resolution-error) (:namespace)
...
###### [reader](42da) `40ants-routes/errors:route-name` (url-resolution-error) (:route-name)
...
#### [package](38b0) `40ants-routes/find-route`
...
##### [function](f0eb) `40ants-routes/find-route:find-route` name &key namespace on-match
...
#### [package](83b9) `40ants-routes/generics`
...
##### [generic-function](bd61) `40ants-routes/generics:add-route` routes route-or-routes-to-add &key override
...
##### [generic-function](fa1f) `40ants-routes/generics:format-url` obj stream args
...
##### [generic-function](9b29) `40ants-routes/generics:get-route-breadcrumbs` node
...
##### [generic-function](e903) `40ants-routes/generics:has-namespace-p` routes
...
##### [generic-function](e87b) `40ants-routes/generics:match-url` obj url &key on-match
...
##### [generic-function](4605) `40ants-routes/generics:node-namespace` routes
...
##### [generic-function](32b3) `40ants-routes/generics:partial-match-url` obj url
...
##### [generic-function](1c06) `40ants-routes/generics:url-path` obj
...
#### [package](b21e) `40ants-routes/handler`
...
##### [function](76a9) `40ants-routes/handler:call-handler`
...
#### [package](eecd) `40ants-routes/included-routes`
...
###### [class](5458) `40ants-routes/included-routes:included-routes` ()
...
###### [reader](d3d7) `40ants-routes/included-routes:original-routes` (included-routes) (:original-collection)
...
###### [reader](7544) `40ants-routes/generics:url-path` (included-routes) (:path)
...
##### [function](cd15) `40ants-routes/included-routes:included-routes-p` obj
...
#### [package](5e30) `40ants-routes/matched-route`
...
###### [class](580c) `40ants-routes/matched-route:matched-route` ()
...
###### [reader](1dfa) `40ants-routes/matched-route:matched-route-parameters` (matched-route) (:parameters = nil)
...
###### [reader](07b1) `40ants-routes/matched-route:original-route` (matched-route) (:original-route)
...
##### [function](3ea0) `40ants-routes/matched-route:matched-route-p` obj
...
#### [package](9a84) `40ants-routes/route`
...
###### [class](a1b7) `40ants-routes/route:route` ()
...
###### [reader](e7b3) `40ants-routes/route:route-handler` (route) (:handler)
...
###### [reader](14c1) `40ants-routes/route:route-method` (route) (:method = :get)
...
###### [reader](999e) `40ants-routes/route:route-name` (route) (:name)
...
###### [reader](5e64) `40ants-routes/route:route-title` (route) (:title = nil)
...
###### [reader](cd84) `40ants-routes/generics:url-path` (route) (:pattern)
...
###### [class](10c2) `40ants-routes/url-pattern:url-pattern` ()
...
###### [reader](1dea) `40ants-routes/url-pattern:url-pattern-params` (url-pattern) (:params)
...
###### [reader](ff53) `40ants-routes/url-pattern:url-pattern-pattern` (url-pattern) (:pattern)
...
###### [reader](5d3e) `40ants-routes/url-pattern:url-pattern-regex` (url-pattern) (:regex)
...
##### [function](c8fd) `40ants-routes/route:current-route`
...
##### [function](bbd1) `40ants-routes/route:current-route-p`
...
##### [function](4e2f) `40ants-routes/route:routep` obj
...
#### [package](bb25) `40ants-routes/route-url`
...
##### [function](5628) `40ants-routes/route-url:route-url` name &rest args &key namespace &allow-other-keys
...
#### [package](78fe) `40ants-routes/routes`
...
###### [class](3d07) `40ants-routes/routes:routes` ()
...
###### [reader](9b7d) `40ants-routes/routes:children-routes` (routes) (:children = nil)
...
###### [reader](5c09) `40ants-routes/generics:node-namespace` (routes) (:namespace)
...
###### [accessor](9b7d) `40ants-routes/routes:children-routes` (routes) (:children = nil)
...
###### [accessor](5c09) `40ants-routes/generics:node-namespace` (routes) (:namespace)
...
##### [function](db7c) `40ants-routes/routes:routesp` obj
...
##### [macro](5998) `40ants-routes/routes:routes` (namespace &key (routes-class 'routes)) &body route-definitions
...
#### [package](9709) `40ants-routes/url-pattern`
...
##### [function](657d) `40ants-routes/url-pattern:parse-url-pattern` pattern
...
##### [function](54b6) `40ants-routes/url-pattern:url-pattern-equal` left right

Compares two [`url-pattern`][a13f] objects

<a id="x-2840ANTS-ROUTES-2FURL-PATTERN-3AURL-PATTERN-P-20FUNCTION-29"></a>

##### [function](c23b) `40ants-routes/url-pattern:url-pattern-p` obj
...
#### [package](adcf) `40ants-routes/with-url`
...
##### [macro](eb09) `40ants-routes/with-url:with-partially-matched-url` (root-routes url) &body body
...
##### [macro](9ab9) `40ants-routes/with-url:with-url` (root-routes url) &body body
...
[304f]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/breadcrumbs.lisp#L1
[9fe1]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/breadcrumbs.lisp#L35
[590f]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/breadcrumbs.lisp#L36
[1533]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/breadcrumbs.lisp#L39
[f5f3]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/breadcrumbs.lisp#L42
[4191]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/breadcrumbs.lisp#L84
[cfc8]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/breadcrumbs.lisp#L92
[83ec]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/defroutes.lisp#L1
[18fd]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/defroutes.lisp#L146
[2874]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/defroutes.lisp#L150
[ea45]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/defroutes.lisp#L154
[563b]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/defroutes.lisp#L166
[361a]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/defroutes.lisp#L36
[5998]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/defroutes.lisp#L74
[739e]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/defroutes.lisp#L91
[04a5]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/errors.lisp#L1
[78cf]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/errors.lisp#L24
[0818]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/errors.lisp#L35
[bab8]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/errors.lisp#L49
[5882]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/errors.lisp#L63
[42da]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/errors.lisp#L74
[0de1]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/errors.lisp#L85
[38b0]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/find-route.lisp#L1
[f0eb]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/find-route.lisp#L103
[83b9]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/generics.lisp#L1
[e87b]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/generics.lisp#L14
[32b3]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/generics.lisp#L30
[fa1f]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/generics.lisp#L42
[1c06]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/generics.lisp#L48
[e903]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/generics.lisp#L52
[4605]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/generics.lisp#L58
[bd61]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/generics.lisp#L62
[9b29]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/generics.lisp#L68
[b21e]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/handler.lisp#L1
[76a9]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/handler.lisp#L15
[eecd]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/included-routes.lisp#L1
[5458]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/included-routes.lisp#L20
[d3d7]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/included-routes.lisp#L21
[7544]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/included-routes.lisp#L25
[cd15]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/included-routes.lisp#L39
[5e30]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/matched-route.lisp#L1
[580c]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/matched-route.lisp#L22
[07b1]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/matched-route.lisp#L23
[1dfa]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/matched-route.lisp#L27
[3ea0]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/matched-route.lisp#L44
[bb25]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/route-url.lisp#L1
[5628]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/route-url.lisp#L27
[9a84]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/route.lisp#L1
[a1b7]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/route.lisp#L32
[999e]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/route.lisp#L33
[cd84]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/route.lisp#L37
[e7b3]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/route.lisp#L41
[5e64]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/route.lisp#L45
[14c1]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/route.lisp#L50
[4e2f]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/route.lisp#L68
[bbd1]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/route.lisp#L80
[c8fd]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/route.lisp#L88
[78fe]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/routes.lisp#L1
[3d07]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/routes.lisp#L21
[9b7d]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/routes.lisp#L22
[5c09]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/routes.lisp#L26
[db7c]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/routes.lisp#L39
[9709]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/url-pattern.lisp#L1
[c23b]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/url-pattern.lisp#L172
[54b6]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/url-pattern.lisp#L179
[10c2]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/url-pattern.lisp#L24
[ff53]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/url-pattern.lisp#L25
[5d3e]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/url-pattern.lisp#L28
[1dea]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/url-pattern.lisp#L31
[657d]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/url-pattern.lisp#L46
[adcf]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/with-url.lisp#L1
[eb09]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/with-url.lisp#L112
[9ab9]: https://github.com/40ants/routes/blob/1884ffd10f3c745df74b273646d544f6580bc4e4/src/with-url.lisp#L86
